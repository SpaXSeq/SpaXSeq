      ...
      tabPanel(
        ...
        sidebarLayout(
          sidebarPanel(
            ...
            numericInput("logfc", "Log2FC of Group 1/Group 2",
    ...
    navlistPanel(
      ...
      tabPanel(
        ...
        tabsetPanel(type = "tabs",
                    ...
                    tabPanel("Heatmap",
                             dropdownButton(
                               numericInput("top_gene_seurat", "Select the number of top genes :",
                                            min = 1, max = 1000, value = 100, step = 1),
                               icon = icon("gear"),
                               width = "300px",
                               tooltip = tooltipOptions(title = "Click to change the number of genes")
                             ),
                             plotOutput("heatmap_seurat", height = "800px"))
        )
      ),
      tabPanel(
        title = "Differential expression",
